...
from cloudv_ostf_adapter.ostf_adapter.wsgi import access_control
from cloudv_ostf_adapter.ostf_adapter.wsgi import hooks
from cloudv_ostf_adapter.ostf_adapter.wsgi.root import RootController  # noqa
...
def setup_config(custom_pecan_config):
    ...
    config_to_use = {
        ...
        'app': {
            'root': RootController.__class__.__name__,
            'modules': ['cloudv_ostf_adapter.ostf_adapter.wsgi']
        },
    }
